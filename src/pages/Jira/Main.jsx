...
import BG from "@assets/tasks.gif";
...
export default function Main({ di }) {
    ...
    return (
        <div className="h-full w-full flex bg-cover bg-center overflow-hidden bg-no-repeat bg-center" style={{ backgroundImage: `url(${BG})` }}>
            {/* Sidebar Navigation */}
